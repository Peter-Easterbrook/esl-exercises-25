    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.paragraph}>
            Our mission is to make quality English language education accessible
            to everyone. Through this mobile application, we provide structured,
            engaging exercises that help learners master English grammar,
            vocabulary, and usage at their own pace.
          </ThemedText>
        </View>
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.paragraph}>
            Founded with a passion for language education, Easterbrook Language
            Services has grown from a local tutoring service to a comprehensive
            language learning platform. Our expertise spans traditional
            classroom instruction, corporate training, and modern digital
            learning solutions.
          </ThemedText>
        </View>
        ...
        <View style={styles.section}>
          ...
          <ThemedText style={styles.paragraph}>
            ...
            reinforce learning.{'\n\n'}
            <ThemedText style={styles.bold}>Progress Tracking:</ThemedText>{' '}
            Monitor your improvement with comprehensive statistics and
            achievement tracking.{'\n\n'}
            <ThemedText style={styles.bold}>Flexible Learning:</ThemedText>{' '}
